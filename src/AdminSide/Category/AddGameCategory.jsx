    ...
    return (
        <>
            <div className="d-flex justify-content-start my-4">
                <Button className="primary-btn" onClick={() => setCatAddModal(true)}>Add Category</Button>
            </div>
            <Modal
                style={{ boxShadow: "4px 4px 4px black" }}
                size="md"
                show={catAddModal}
                onHide={() => setCatAddModal(false)}
                aria-labelledby="example-modal-sizes-title-sm"
            >
                <div style={{ boxShadow: "0 4px 20px rgba(0,0,0,0.6)", borderRadius: "8px" }}>
                    ...
                    <Modal.Body>
                        <Form className='form-group admin-form p-3' style={{ boxShadow: "none" }}>
                            ...
                            <div className="text-center">
                                <Button onClick={AddCategory} className='primary-btn mt-3 text-white'>Add Category</Button>
                            </div>
                        </Form>
                    </Modal.Body>
                </div>
